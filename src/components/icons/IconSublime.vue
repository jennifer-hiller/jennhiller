<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
    ...
    <path
      style="opacity: 0.2"
      d="m24 6-16 5v6l7.273 2.727-7.273 2.273v6l16-5v-6l-7.273-2.727 7.273-2.273z"
    ></path>
    <path style="fill: #ffab36" d="m24 5-16 5v6l16-5z"></path>
    <path style="fill: #ffab36" d="m24 16-16 5v6l16-5z"></path>
    <path
      style="opacity: 0.2"
      d="m22.545 16.455l-8.727 2.727 8.727 3.273 1.455-0.455v-5l-1.455-0.545z"
    ></path>
    <path style="fill: #ffab36" d="m8 10 16 6v6l-16-6z"></path>
  </svg>
</template>
